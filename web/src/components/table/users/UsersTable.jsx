...
import ChangeIdentityModal from './modals/ChangeIdentityModal';
...
const UsersTable = (usersData) => {
  ...
  const [showUserSubscriptionsModal, setShowUserSubscriptionsModal] =
    useState(false);
  const [showChangeIdentityModal, setShowChangeIdentityModal] = useState(false);
  ...
  const showChangeIdentityUserModal = (user) => {
    setModalUser(user);
    setShowChangeIdentityModal(true);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showChangeIdentityModal: showChangeIdentityUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      <ChangeIdentityModal
        visible={showChangeIdentityModal}
        handleClose={() => setShowChangeIdentityModal(false)}
        user={modalUser}
        refresh={refresh}
      />
    </>
